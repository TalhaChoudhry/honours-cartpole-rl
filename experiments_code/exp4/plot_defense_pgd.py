...
def main():
    ...
    ap.add_argument("--out", default=r"figures\pgd_defense_vs_baseline.png")
    ap.add_argument("--summary_csv", default=r"figures\pgd_defense_vs_baseline_summary.csv")
    args = ap.parse_args()
    ...
    # Expect columns: epsilon, mean, std, label (plus steps info)
    def pick(df, lab):
    ...
    plt.title("PGD — Baseline vs Defense")
    plt.legend()
    ...
    print("\n=== PGD Summary (Δ=defense-baseline, %Δ) ===")
